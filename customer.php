			...
			<form class="form-horizontal" action="add.php" method="post">
			 <div class="form-row">
				<div class="form-group col-md-6">
				  ...
				  <input type="text" class="form-control" name="No Reg" placeholder="Input No Reg">
				</div>
				<div class="form-group col-md-6">
				...
				<div class="form-group col-md-6">
				  <label for="">Hp </label>
				  <input type="text" class="form-control" name="Hp" placeholder="Input Nomer Hp">
				</div>
			  </div>
			  <div class="form-row">
			  <div class="form-group col-md-6">
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <?php 
						include 'koneksi.php';
						$stid = oci_parse($conn, 'SELECT * from bengkel');
						oci_execute($stid);
                        ...
                        <tr>
                          ...
                          <td class="td-actions">
						  <a href="Customer_update.php?id=<?= $d['NO_REG'] ?>">
                            <button type="button" rel="tooltip" class="btn btn-success">
                              <i class="material-icons">edit</i>
                            </button></a>
							<a href="delete.php?id=<?= $d['NO_REG'] ?>" 
