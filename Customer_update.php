          ...
          <div class="row">
			...
			<?php
				...
				if (isset($_GET['id'])) {
				  ...
				  $stid = oci_parse($conn,"SELECT * FROM bengkel WHERE NO_REG = '$NO_REG'");
				  oci_execute($stid);
				 while (($d = oci_fetch_array($stid, OCI_BOTH)) != false) {
				  ?>
			<form class="form-horizontal" action="proses_updatepsn.php" method="post">
			 <div class="form-row">
				
				
				  <input type="hidden" class="form-control" name="no_reg" value="<?= $d['NO_REG'] ?>" >
